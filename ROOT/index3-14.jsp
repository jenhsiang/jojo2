...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">空中之城(Celestia)</font></h2>
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic20.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 這是款簡單的數字卡片遊戲，玩家們要盡量避免吃到牛頭，所以要小心計算出牌。這遊戲比較適合5人以上，越多人玩越緊張刺激，輪到你放牌的時候如果被強迫收走牛頭，
			 會一整個high起來，是個非常不錯的派對遊戲，但圖案較單純，所以有些玩家也是不太喜歡，但我覺得如果人多，玩過一次就會被吸引，算是賣相較不佳的遊戲。在熱氣球之旅中，
			 玩家要趕在熱氣球上升時留在籃中而贏得分數。分數會隨著熱氣球攀升上一層又一層的雲層而升高，但相對地，危險性也隨之升高。在適當的時機跳出籃外且贏得高分。
			 取得最多分的玩家獲勝！熱氣球之旅包含了一系列的熱氣球旅行。一場熱氣球之旅只要熱氣球持續上升就會繼續進行。玩家輪流在熱氣球從一朵雲上升到下一朵雲時擔任飛行員。
			 當熱氣球墜落，旅途結束。</br>
			</font>
			</p>
			</th>
