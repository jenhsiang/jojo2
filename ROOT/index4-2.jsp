...
<li>
    ...
    <div style="float: left;">
        ...
        <p style="color:BLACK;">作者：Stefan Dorra & Ralf zur Linde</p>
...
<table width="90%" bgcolor="WHITE" border="1" BORDERCOLOR=#00b36b style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-3.jsp"><img src="pic4.jpg" alt="卡卡頌(Carcassonne)" id="itemImg" width="200" height="250"></a>
				</div>
				<div style="float: left;">
					<H2 style="color:BLUE;">卡卡頌(Carcassonne)</H2>
...
<li>
    <div style="float: left;">
        <a href="index3-5.jsp"><img src="pic14.jpg" alt="驢橋" id="itemImg" width="200" height="250"></a>
    </div>
    				<div style="float: left;">
...
<table width="90%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-6.jsp"><img src="pic15.jpg" alt="妙語說書人" id="itemImg" width="200" height="250"></a>
				</div>
								<div style="float: left;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-7.jsp"><img src="pic11.jpg" alt="矮人礦坑" id="itemImg" width="200" height="250"></a>
				</div>
								<div style="float: left;">
...
<li>
    <div style="float: left;">
        <a href="index3-8.jsp"><img src="pic7.jpg" alt="驢橋" id="itemImg" width="200" height="250"></a>
    </div>
    				<div style="float: left;">
