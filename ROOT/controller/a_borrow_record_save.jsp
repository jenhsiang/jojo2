			...
			if(result == 1 && (new_action.equals("returnbook") || new_action.equals("paybook"))){
			  ...
			  if(result == 1) {  
						SendMailTLS mail = new SendMailTLS();
							...
							boolean check = false;	
							if(new_action.equals("getbook")){
								check =	mail.sendmail( member_email + ",ed01039639@gmail.com", "天天學桌遊--取貨通知(" + member_name +")", mailcontect,6);
							}else if(new_action.equals("returnbook")){
								check =	mail.sendmail( member_email + ",ed01039639@gmail.com", "天天學桌遊--還書通知(" + member_name +")", mailcontect,7);
							}else if(new_action.equals("paybook")){
