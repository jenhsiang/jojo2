...
Ext.onReady(function() {
  ...
  //deliver_main
    var columns = [
		...
		{header: '租書狀態', dataIndex: 'borrow_status', renderer: Renderer_status, sortable: true},
		...
		{header: '借書日期', dataIndex: 'borrow_date', renderer: fGridTooltips, sortable: true},
  ...
  //deliver_main
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        tbar: [{ 
                ...
                store : Ext.create('Ext.data.Store',{ 
                    fields : ['name','value'], 
                    data : [{'name':'已歸還','value':0},{'name':'預約中','value':1},{'name':'已超過預約期限','value':2},{'name':'借閱中','value':3},{'name':'已超過借閱期限，請盡快還書','value':4},{'name':'已付過罰金','value':5}] 
                }), 
                emptyText : '請選擇租書狀況', 
                displayField : 'name', 
                valueField : 'value'
        ...
        items: [{
            ...
            items:[{
                ...
                items: [{                     //这里可以为多个Item，表现出来是该列的多行	
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ['value','text'],
                        data: [[0,'已歸還'],[1,'預約中'],[2,'已超過預約期限'],[3,'借閱中'],[4,'已超過借閱期限，請盡快還書'],[5,'已付過罰金']]	
                    }),
                    emptyText: '請選擇',
                    mode: 'local',
                    triggerAction: 'all',
