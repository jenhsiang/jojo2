...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">情書(Love Letter)</font></h2>
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="pic15.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 1.遊戲會進行數局，每一局代表一天。<br>
			 2.   先從牌庫中抽一張牌加入手牌中。<br>
			 3.   選擇一張牌棄掉，面朝上放在自己面前。<br>
			 4.   發動棄掉牌的效果。每張角色的效果如下：
遊戲當中若有人出局，出局的玩家將他手上的牌攤開放在自己面前(不需執行此張牌的效果)，表示今天他已經沒有機會將情書送到公主面前啦!<br>
