...
<body  background="gameboardbg.jpg" > 
...
<table border="0" background="bg4.jpg" cellspacing="1" cellpadding="0" style="width:70%" align="center">
...
%>
  ...
  <tr>
    ...
    <td width="140" valign="top"><p><a href=""><img border="1" width="270" height="330" src="<%=book_img%>" alt="bvcb" /></a></p></td>
    <td width="800" valign="top"><table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
        <td colspan="2"><h2 style="color: #088A85"><%=book_name%>
		...
		<%}
              ...
              <H3><font color="black">人數：<%=publishing%></font></H3></td>
      </tr>
      <tr>
        <td colspan="2"><H3><font color="black">作者：<%=author%></font></H3></td>
      </tr>
      <tr>
        <td colspan="2"><H3><font color="black">出版日期：<%=release_date%></font></H3</td>
      </tr>
      <tr>
        <td colspan="2"><table border="0" cellspacing="1" cellpadding="0" width="100%">
          <tr>
            <td><H3><font color="black">類別：<%=choice_name%></font></H3></td>
          </tr>
        </table></td>
      </tr>
      
      <tr>
        <td><H3><font color="black">Price: <span class="style3"><%=book_price%></span> NTD</font></H3>
		</td>
