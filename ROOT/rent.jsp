...
<body  bgcolor="#FFFCA7"> 
 ...
 <table>
		<tr>
		<p style="color:#088A85" align="center" ><font face="Algerian" size="250">GAMEBOARD WORLD</font><a href="https://www.facebook.com/%E5%A4%A9%E5%A4%A9%E5%AD%B8%E6%A1%8C%E9%81%8A-1118376901610135/"  target="_blank" ></a>
		<a href="https://www.facebook.com/%E5%A4%A9%E5%A4%A9%E5%AD%B8%E6%A1%8C%E9%81%8A-1118376901610135/"  target="_blank" ><img src="fb.png" style="width:50px;height:40px;" align="right"><img src="in.png" style="width:50px;height:40px;" align="right"></a></p>
		<hr>
	...
	<div id="tfheader">
		<form id="tfnewsearch" action = "rent.jsp"  method="post" ng-init="setFirst('<%=firstchoice%>','<%=secondchoice%>');">
...
<h2 style="color:blACK" align="center" ><font face="Algerian">BOOKING STATUS</font></h2>
...
%>			
 ...
 <%
	...
	if(even_rent == 0){
%>
<h1 align="center">您目前借閱的書都已歸還~~~</h1>
<%}%>
</table>
</div>
</body>
